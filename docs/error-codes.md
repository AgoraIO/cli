...
| `QUICKSTART_REQUIRED_FEATURE_MISSING` | 1 | An existing project does not provide every feature required by the selected quickstart. | Run the `agora project feature enable ...` command in the error, then retry. |
