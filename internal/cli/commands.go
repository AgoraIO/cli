...
`),
	...
	create.Flags().StringVar(&createFeature, "feature", "", "project feature for the webhook configuration")
	...
	update.Flags().StringVar(&updateFeature, "feature", "", "project feature for the webhook configuration")
