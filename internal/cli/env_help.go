...
func agoraEnvCatalog() []agoraEnvVar {
	return []agoraEnvVar{
		...
		{Name: "AGORA_LOGIN_TIMEOUT_MS", Category: "interaction", Description: "How long to wait for the OAuth callback before giving up.", Default: "120000", Effect: "milliseconds"},
		...
		{Name: "AGORA_RECIPES_BASE_URL", Category: "endpoints", Description: "Override the versioned Agora recipes API base URL for staging and integration tests.", Default: "https://recipes.agora.io/api/v1"},
