...
func renderOAuthCallbackPage(content loginPageContent, isError bool, errorTitle, errorMessage string) string {
	...
	b.WriteString(escapeAttr(content.Language))
	b.WriteString(`"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Agora CLI Login</title><style>`)
